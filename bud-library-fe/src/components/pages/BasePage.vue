<template>
  <div class="d-none">  {{loadScript}} </div>
  <div class="base-page">
    ...
    <div class="main" style="position: relative; z-index: 1050;">
      <router-view class="main-content" style="padding: 0px 100px 0 100px !important;" :key="$route.fullPath"></router-view>
    </div>
  </div>
</template>
...
import Footer from '../parts/normals/Footer.vue'
...
export default {
  ...
  created(){
    ...
    mounted() {
        console.log('Component mounted BaseAdmin.')
...
.table-content-item {
  ...
  border: 1px solid rgb(255, 245, 187);
  width: 100%;
